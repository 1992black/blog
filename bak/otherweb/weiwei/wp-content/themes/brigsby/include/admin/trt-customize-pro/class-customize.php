	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Hoot_Premium_Customize_Section_Pro(
				...
				'hoot_premium',
				array(
					'title'    => esc_html__( 'Brigsby Premium', 'brigsby' ),
					'priority' => 1,
					'pro_text' => esc_html__( 'Premium', 'brigsby' ),
					'pro_url'  => admin_url('/') . 'themes.php?page=brigsby-premium',
					'demo'     => 'http://demo.wphoot.com/brigsby/',
					'docs'     => 'http://wphoot.com/support/',
					'rating'   => 'https://wordpress.org/support/view/theme-reviews/brigsby#postform',
				)
			)
		);
	}
