    ...
    <div class="sidebar-inner">
      <section class="site-overview sidebar-panel <?php if(!$this->is('post')) echo "sidebar-panel-active";?>">
        <div class="site-author motion-element" itemprop="author" itemscope itemtype="http://schema.org/Person">
          ...
          -->
          <img class="site-author-image" src="http://www.gravatar.com/avatar/9c2ac48892584e8688f2235a77e8f90f?s=220&r=X&d=mm" alt="<?php $this->options->next_name(); ?>" itemprop="image"/>
